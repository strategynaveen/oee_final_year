...
<div style="margin-left: 4.5rem;">
        ...
        <div class="OuterCard graphCardMain">
          <div class="card bodercss" style="width: 80%">
              ...
              <div class="container-fluid paddingm">
                <p class="float-start fontBold graph_header" id="">MACHINE-WISE OEE% BREAKDOWN</p>
                  <div class="d-flex">
                        <!-- <div class="rightmar">
        ...
        <div class="OuterCard graphCardMain">
          <div class="card bodercss" style="width: 80%">
              <nav class="navbar navbar-expand-lg">
              <div class="container-fluid paddingm">
                <p class="float-start fontBold graph_header" id="">AVAILABILITY OPPORTUNITY</p>
                  <div class="d-flex">
                        <!-- <div class="rightmar">
                          <select class="form-select" name="" id="" style="width: 10rem;">
                                </select>
        ...
        <div class="OuterCard graphCardMain">
          <div class="card bodercss" style="width: 80%"> 
              <nav class="navbar navbar-expand-lg">
              <div class="container-fluid paddingm">
                <p class="float-start fontBold graph_header" id="">PERFORMANCE OPPORTUNITY</p>
                  <div class="d-flex">
                        <!-- <div class="rightmar">
        ...
        <div class="OuterCard graphCardMain">
          <div class="card bodercss" style="width: 80%">
              <nav class="navbar navbar-expand-lg">
              <div class="container-fluid paddingm">
                <p class="float-start fontBold graph_header" id="">QUALITY OPPORTUNITY</p>
                  <div class="d-flex">
                        <!-- <div class="rightmar">
                          <select class="form-select" name="" id="" style="width: 10rem;"></select>
                        </div>
        ...
        <div class="OuterCard graphCardMain">
          <div class="card bodercss" style="width: 80%">
              <nav class="navbar navbar-expand-lg">
              <div class="container-fluid paddingm">
                <p class="float-start fontBold graph_header" id="">OEE TREND</p>
                  <div class="d-flex">
                        <!-- <div class="rightmar">
                          <select class="form-select" name="" id="" style="width: 10rem;"></select>
                        </div>
