...
// 	}
// 	else{
// 		$('#inputNewToolName').val($('#inputNewToolName').val().substring(0,25));
// 	}
// });
...
function EditNewToolName(){
	var val = $("#EditNewToolName").val();
	if (!val) {
		$(".Add_Tool_Data").attr("disabled", true);
		return "Tool Name**";
	}
...
$('#EditNewToolName').on('blur',function(){
    var x =EditNewToolName();
 	$(".EditNewToolNameErr").html(x);
});
